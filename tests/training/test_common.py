"""Source-seeded deterministic candidate bundle (shared SFT/RL fixture policy).

Phase 6: the baseline fixture must not fix the ground truth at position 1
(which would leak a systematic {"answer":"1"} bias into every Stage 2
sample). These tests pin the deterministic, source_id-seeded permutation in
agent.training.common.build_candidates.
"""
